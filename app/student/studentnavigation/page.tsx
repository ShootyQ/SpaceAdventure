...
export default function StudentNavigationPage() {
    ...
    const saveName = async (field: "avatar" | "ship" | "pet") => {
        ...
        if (!isValidProfileName(nextValue)) {
            setNotice("Names must be 1-30 characters and use letters, numbers, spaces, or periods.");
            return;
        }
            ...
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                <div className="border border-cyan-500/20 bg-black/40 rounded-2xl p-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <NavCard href="/student/settings?view=inventory" title="Cargo Hold" subtitle="Inventory grid and field gear" />
                        <NavCard href="/student/settings?view=ship" title="Ship Systems" subtitle="Hull stats and installed systems" />
                        <NavCard href="/student/crafting" title="Crafting Table" subtitle="Build machines and forge upgrades" />
