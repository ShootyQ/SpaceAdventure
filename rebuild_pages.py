...
# Content for app/space/page.tsx
space_page = r'''"use client";
...
# Content for app/about/page.tsx
...
# Content for app/educators/page.tsx
educators_page = r'''import Link from 'next/link';
...
files = {
    "app/space/page.tsx": space_page,
    "app/page.tsx": crave_page,
    "app/about/page.tsx": about_page,
    "app/educators/page.tsx": educators_page
}
...
for path, content in files.items():
    ...
    print(f"Wrote {path} successfully.")
