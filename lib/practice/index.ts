...
export const PRACTICE_TEMPLATES: PracticeTemplate[] = [
    ...
    {
        id: 'math-slope-graph-points',
        name: 'Slope-Intercept: Plot Two Points',
        description: 'Given y = mx + b, place two correct points on the coordinate plane.',
        grades: [7, 8],
        category: 'algebra',
    },
    {
        id: 'math-slope-intercept-from-graph',
        name: 'Slope-Intercept from Graph',
        description: 'Given a graphed line, write the equation in y = mx + b form.',
        grades: [7, 8],
        category: 'algebra',
    },
    {
        ...
        name: 'Systems Intro',
        description: 'Solve linear systems with integer coefficients using substitution or elimination.',
        grades: [8],
        category: 'algebra',
    },
];
