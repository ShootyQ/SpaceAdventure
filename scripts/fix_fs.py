...
# Construct full page content
page_full = page_p1 + page_p2 + page_p3 + page_p4 + page_p5 + page_p6

# Write ManifestOverlay.tsx
try:
    with open('components/ManifestOverlay.tsx', 'w', encoding='utf-8') as f:
        f.write(manifest_content)
    print("Successfully wrote components/ManifestOverlay.tsx")
except Exception as e:
    print(f"Error writing components/ManifestOverlay.tsx: {e}")

# Write app/student/settings/page.tsx
try:
    with open('app/student/settings/page.tsx', 'w', encoding='utf-8') as f:
        f.write(page_full)
    print("Successfully wrote app/student/settings/page.tsx")
except Exception as e:
    print(f"Error writing app/student/settings/page.tsx: {e}")
